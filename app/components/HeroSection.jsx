  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 text-white">
        <h1 className="text-2xl md:text-3xl max-w-3xl mx-auto mb-6 font-semibold">
      ...
      <FaArrowDown
        ...
        className="animate-bounce text-5xl z-20 mt-4 text-rose-700 hover:text-rose-500 cursor-pointer"
